 ...
 *   3. Detect rising edges on `intent.trickLeft` / `intent.trickRight`.
 *      Holding the button does nothing — only fresh presses count.
 *   4. On a rising edge while grounded + past cooldown:
 ...
 * no boost.
 *
 * Visual-only spin: this system never torques the rigid body. The
