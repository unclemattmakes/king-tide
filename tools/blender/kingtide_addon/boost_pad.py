...
class KINGTIDE_OT_add_boost_pad(Operator):
    ...
    bl_idname = "kingtide.add_boost_pad"
...
class KINGTIDE_OT_refresh_boost_pads(Operator):
    ...
    bl_idname = "kingtide.refresh_boost_pads"
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_add_boost_pad,
    KINGTIDE_OT_refresh_boost_pads,
)
