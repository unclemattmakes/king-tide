...
def _repo_root() -> str | None:
    ...
    the addon's exporter: project-root preference → ``$KINGTIDE_REPO_ROOT`` →
...
class KINGTIDE_OT_write_prop_placements(bpy.types.Operator):
    ...
    bl_idname = "kingtide.write_prop_placements"
...
class KINGTIDE_OT_set_prop_float(bpy.types.Operator):
    ...
    *Write Prop Placements → JSON*. At runtime a floated prop becomes a
    ...
    bl_idname = "kingtide.set_prop_float"
...
class KINGTIDE_PT_props(bpy.types.Panel):
    bl_label = "Prop Placements"
    bl_idname = "KINGTIDE_PT_props"
    ...
    def draw(self, context):
        ...
        col.operator("kingtide.import_prop_placements", icon="IMPORT")
        col.operator("kingtide.write_prop_placements", icon="EXPORT")
        ...
        box.operator("kingtide.set_prop_float", icon="CHECKMARK")


_CLASSES = (
    KINGTIDE_OT_import_prop_placements,
    KINGTIDE_OT_write_prop_placements,
    KINGTIDE_OT_set_prop_float,
    KINGTIDE_PT_props,
)
