...
class KINGTIDE_PT_prop_lines(bpy.types.Panel):
    bl_label = "Prop Lines"
    bl_idname = "KINGTIDE_PT_prop_lines"
    ...
    def draw(self, context):
        ...
        col.operator("kingtide.import_prop_lines", icon="IMPORT")
        col.operator("kingtide.write_prop_lines", icon="EXPORT")
        self.layout.label(text="Edit a propLine_* curve, then Write.", icon="INFO")


_CLASSES = (
    KINGTIDE_OT_import_prop_lines,
    KINGTIDE_OT_write_prop_lines,
    KINGTIDE_PT_prop_lines,
)
