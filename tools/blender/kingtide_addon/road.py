...
def rebuild_road_main(
    ...
    *,
    ...
    terrain. The single source of truth shared by:
      ...
      * ``KINGTIDE_OT_build_road`` — explicit user click.
...
class KINGTIDE_OT_build_road(Operator):
...
class KINGTIDE_OT_bake_terrain_to_road(Operator):
    ...
    * The live ``HV_RoadConform`` modifier is auto-disabled for the
    ...
    bl_idname = "kingtide.bake_terrain_to_road"
...
class KINGTIDE_OT_reconform_terrain_to_road(Operator):
    ...
    *mesh* — not the curve. Useful after:
    ...
    bl_idname = "kingtide.reconform_terrain_to_road"
...
class KINGTIDE_OT_mark_selected_floating(Operator):
    ...
    bl_idname = "kingtide.mark_selected_floating"
...
class KINGTIDE_OT_mark_selected_conforming(Operator):
    ...
    bl_idname = "kingtide.mark_selected_conforming"
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_add_road_starter_curve,
    KINGTIDE_OT_build_road,
    KINGTIDE_OT_bake_terrain_to_road,
    KINGTIDE_OT_reconform_terrain_to_road,
    KINGTIDE_OT_mark_selected_floating,
    KINGTIDE_OT_mark_selected_conforming,
)
