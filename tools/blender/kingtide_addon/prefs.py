...
The addon normally infers your king-tide clone by walking up from the open
...
This preference (or the ``$KINGTIDE_REPO_ROOT`` env var) names your clone
...
class KingTideAddonPreferences(AddonPreferences):
    ...
    project_root: StringProperty(
        name="Project root",
        description=(
            "Path to your king-tide repo clone. Set this only when you author "
...
_CLASSES: tuple[type, ...] = (KingTideAddonPreferences,)
