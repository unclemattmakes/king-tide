...
class KINGTIDE_OT_rebuild_turn_indicators(Operator):
    ...
    bl_idname = "kingtide.rebuild_turn_indicators"
...
class KINGTIDE_OT_hide_turn_indicators(Operator):
    """Hide the turn-indicator collection without deleting it."""

    bl_idname = "kingtide.hide_turn_indicators"
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_rebuild_turn_indicators,
    KINGTIDE_OT_hide_turn_indicators,
)
