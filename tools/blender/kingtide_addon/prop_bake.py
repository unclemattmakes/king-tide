...
def _hoverbike_save_pre_bake(*_args):
    ...
    if baked:
        print(
            f"[kingtide] save_pre: baked {len(baked)} prop mesh(es): "
            f"{', '.join(baked)}"
        )
...
class KINGTIDE_OT_setup_prop_mesh_bake(Operator):
    ...
    bl_idname = "kingtide.setup_prop_mesh_bake"
...
class KINGTIDE_OT_bake_prop_meshes(Operator):
    ...
    bl_idname = "kingtide.bake_prop_meshes"
...
class KINGTIDE_PT_props_library_bake(Panel):
    ...
    bl_idname = "KINGTIDE_PT_props_library_bake"
    ...
    def draw(self, context):
        ...
        row.operator(KINGTIDE_OT_setup_prop_mesh_bake.bl_idname, icon="MOD_NODES")
        ...
        col.operator(KINGTIDE_OT_bake_prop_meshes.bl_idname, icon="FILE_REFRESH")
...
_CLASSES = (
    KINGTIDE_OT_setup_prop_mesh_bake,
    KINGTIDE_OT_bake_prop_meshes,
    KINGTIDE_PT_props_library_bake,
)
