...
class KINGTIDE_OT_rebuild_ghost_lap(Operator):
    ...
    bl_idname = "kingtide.rebuild_ghost_lap"
...
class KINGTIDE_OT_hide_ghost_lap(Operator):
    ...
    bl_idname = "kingtide.hide_ghost_lap"
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_rebuild_ghost_lap,
    KINGTIDE_OT_hide_ghost_lap,
)
