...
class KINGTIDE_OT_toggle_tunnel_edit_mode(Operator):
    ...
    bl_idname = "kingtide.toggle_tunnel_edit_mode"
...
class KINGTIDE_OT_add_tunnel_starter_curve(Operator):
    ...
    bl_idname = "kingtide.add_tunnel_starter_curve"
...
class KINGTIDE_OT_build_tunnel(Operator):
    ...
    bl_idname = "kingtide.build_tunnel"
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_toggle_tunnel_edit_mode,
    KINGTIDE_OT_add_tunnel_starter_curve,
    KINGTIDE_OT_build_tunnel,
)
