...
class KINGTIDE_OT_add_wave_zone(Operator):
    ...
    bl_idname = "kingtide.add_wave_zone"
...
class KINGTIDE_OT_refresh_wave_zones(Operator):
    ...
    bl_idname = "kingtide.refresh_wave_zones"
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_add_wave_zone,
    KINGTIDE_OT_refresh_wave_zones,
)
