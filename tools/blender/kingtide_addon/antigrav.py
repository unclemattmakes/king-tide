...
class KINGTIDE_OT_add_antigrav_zone(Operator):
    ...
    bl_idname = "kingtide.add_antigrav_zone"
...
class KINGTIDE_OT_refresh_antigrav_zones(Operator):
    ...
    bl_idname = "kingtide.refresh_antigrav_zones"
...
class KINGTIDE_OT_set_spline_tilt(Operator):
    ...
    bl_idname = "kingtide.set_spline_tilt"
...
def _make_tilt_preset(suffix: str, label: str, description: str, radians: float):
    ...
    class _Preset(Operator):
        bl_idname = f"kingtide.set_spline_tilt_{suffix}"
        bl_label = label
    ...
    _Preset.__name__ = f"KINGTIDE_OT_set_spline_tilt_{suffix}"
    _Preset.__qualname__ = _Preset.__name__
    return _Preset


KINGTIDE_OT_set_spline_tilt_flat = _make_tilt_preset(
    "flat", "Flat (0°)", "Set tilt = 0 on selected control points (world-up)", 0.0,
)
KINGTIDE_OT_set_spline_tilt_bank_l = _make_tilt_preset(
    "bank_l", "Bank L (45°)",
    "Set tilt = +π/4 on selected points (banked left, 45°)", math.pi / 4,
)
KINGTIDE_OT_set_spline_tilt_bank_r = _make_tilt_preset(
    "bank_r", "Bank R (−45°)",
    "Set tilt = -π/4 on selected points (banked right, 45°)", -math.pi / 4,
)
KINGTIDE_OT_set_spline_tilt_wall_l = _make_tilt_preset(
    "wall_l", "Wall L (90°)",
    "Set tilt = +π/2 on selected points (vertical wall on the left)", math.pi / 2,
)
KINGTIDE_OT_set_spline_tilt_wall_r = _make_tilt_preset(
    "wall_r", "Wall R (−90°)",
    "Set tilt = -π/2 on selected points (vertical wall on the right)", -math.pi / 2,
)
KINGTIDE_OT_set_spline_tilt_ceiling = _make_tilt_preset(
    "ceiling", "Ceiling (180°)",
    "Set tilt = π on selected points (upside-down ceiling)", math.pi,
)


class KINGTIDE_OT_toggle_spline_antigrav(Operator):
    ...
    bl_idname = "kingtide.toggle_spline_antigrav"
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_add_antigrav_zone,
    KINGTIDE_OT_refresh_antigrav_zones,
    KINGTIDE_OT_set_spline_tilt,
    KINGTIDE_OT_set_spline_tilt_flat,
    KINGTIDE_OT_set_spline_tilt_bank_l,
    KINGTIDE_OT_set_spline_tilt_bank_r,
    KINGTIDE_OT_set_spline_tilt_wall_l,
    KINGTIDE_OT_set_spline_tilt_wall_r,
    KINGTIDE_OT_set_spline_tilt_ceiling,
    KINGTIDE_OT_toggle_spline_antigrav,
)
