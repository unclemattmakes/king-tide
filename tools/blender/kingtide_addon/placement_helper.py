...
class KINGTIDE_OT_add_placement_helper(Operator):
    ...
    bl_idname = "kingtide.add_placement_helper"
...
class KINGTIDE_OT_remove_placement_helper(Operator):
    ...
    bl_idname = "kingtide.remove_placement_helper"
...
class KINGTIDE_OT_cursor_to_helper(Operator):
    ...
    bl_idname = "kingtide.cursor_to_helper"
...
class KINGTIDE_OT_add_boost_pad_at_helper(Operator):
    ...
    def execute(self, context):
        ...
        if snap != {"FINISHED"}:
            return snap
        return bpy.ops.kingtide.add_boost_pad()
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_add_placement_helper,
    KINGTIDE_OT_remove_placement_helper,
    KINGTIDE_OT_cursor_to_helper,
    KINGTIDE_OT_add_ramp_at_helper,
    KINGTIDE_OT_add_boost_pad_at_helper,
)
