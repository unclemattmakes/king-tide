...
class KINGTIDE_OT_import_heightmap(Operator):
    ...
    bl_idname = "kingtide.import_heightmap"
...
class KINGTIDE_OT_apply_terrain_modifiers(Operator):
    ...
    bl_idname = "kingtide.apply_terrain_modifiers"
...
class KINGTIDE_OT_enter_sculpt_mode(Operator):
...
class KINGTIDE_OT_smooth_terrain(Operator):
    ...
    bl_idname = "kingtide.smooth_terrain"
...
class KINGTIDE_OT_subdivide_terrain(Operator):
    ...
    bl_idname = "kingtide.subdivide_terrain"
...
class KINGTIDE_OT_raise_lower_terrain(Operator):
    ...
    bl_idname = "kingtide.raise_lower_terrain"
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_import_heightmap,
    KINGTIDE_OT_apply_terrain_modifiers,
    KINGTIDE_OT_enter_sculpt_mode,
    KINGTIDE_OT_smooth_terrain,
    KINGTIDE_OT_subdivide_terrain,
    KINGTIDE_OT_raise_lower_terrain,
)
