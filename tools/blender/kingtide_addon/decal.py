...
Authoring loop:
  ...
  2. Click **Add Decal** in the King Tide panel's *Decals* sub-section.
...
class KINGTIDE_OT_add_decal(Operator):
...
class KINGTIDE_PT_track_decals(bpy.types.Panel):
    ...
    bl_label = "Decals"
    bl_idname = "KINGTIDE_PT_track_decals"
    ...
    def draw(self, context):
        ...
        layout.operator("kingtide.add_decal", icon="ADD")
        layout.separator()
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_add_decal,
    KINGTIDE_OT_decal_set_cell,
)
