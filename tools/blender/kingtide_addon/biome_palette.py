...
class KINGTIDE_OT_add_biome_palette(Operator):
    ...
    bl_idname = "kingtide.add_biome_palette"
    ...
    def execute(self, context):
        ...
        if result is None:
            self.report(
                ...
                "(or re-save this .blend inside a king-tide clone) and "
                "try again.",
            )
            return {"CANCELLED"}
...
class KINGTIDE_OT_edit_biome_mask(Operator):
    ...
    bl_idname = "kingtide.edit_biome_mask"
...
class KINGTIDE_OT_clear_biome_mask(Operator):
    ...
    bl_idname = "kingtide.clear_biome_mask"
...
class KINGTIDE_PT_track_biome_palette(Panel):
    ...
    bl_idname = "KINGTIDE_PT_track_biome_palette"
    ...
    def draw(self, context):
        ...
        for display, _default_src, _default_density in BIOMES:
            ...
            op = mask_row.operator(
                "kingtide.edit_biome_mask",
                text="Edit mask",
                icon="BRUSH_DATA",
            )
            op.biome = display
            op = mask_row.operator(
                "kingtide.clear_biome_mask",
                text="Clear",
                icon="X",
            )
            op.biome = display
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_add_biome_palette,
    KINGTIDE_OT_edit_biome_mask,
    KINGTIDE_OT_clear_biome_mask,
    KINGTIDE_PT_track_biome_palette,
)
