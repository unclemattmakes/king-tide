...
This module also exposes ``KINGTIDE_OT_apply_terrain_vertex_colors``
...
def _assign_terrain_material(terrain: bpy.types.Object) -> tuple[bool, str]:
    ...
    ``kingtide_addon.terrain_material`` is built fresh. The seeded
...
class KINGTIDE_OT_bake_terrain_attrs(Operator):
    ...
    bl_idname = "kingtide.bake_terrain_attrs"
...
class KINGTIDE_OT_bake_path_worn(Operator):
    ...
    bl_idname = "kingtide.bake_path_worn"
...
class KINGTIDE_OT_apply_terrain_vertex_colors(Operator):
    ...
    bl_idname = "kingtide.apply_terrain_vertex_colors"
...
_CLASSES: tuple[type, ...] = (
    KINGTIDE_OT_bake_terrain_attrs,
    KINGTIDE_OT_bake_path_worn,
    KINGTIDE_OT_apply_terrain_vertex_colors,
)
