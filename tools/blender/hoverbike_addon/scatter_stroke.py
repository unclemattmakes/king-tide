...
class HOVERBIKE_OT_add_scatter_stroke(Operator):
    ...
    bl_idname = "hoverbike.add_scatter_stroke"
    ...
    def execute(self, context):
        ...
        if result is None:
            self.report(
                ...
                "re-save this .blend inside a hoverbike clone.",
            )
            return {"CANCELLED"}
...
class HOVERBIKE_PT_track_scatter_stroke(Panel):
    ...
    bl_idname = "HOVERBIKE_PT_track_scatter_stroke"
...
_CLASSES: tuple[type, ...] = (
    HOVERBIKE_OT_add_scatter_stroke,
    HOVERBIKE_PT_track_scatter_stroke,
)
