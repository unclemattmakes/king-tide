...
class HOVERBIKE_OT_add_antigrav_curve(Operator):
    ...
    bl_idname = "hoverbike.add_antigrav_curve"
...
class HOVERBIKE_OT_build_antigrav_surface(Operator):
    ...
    bl_idname = "hoverbike.build_antigrav_surface"
...
_CLASSES: tuple[type, ...] = (
    HOVERBIKE_OT_add_antigrav_curve,
    HOVERBIKE_OT_build_antigrav_surface,
)
