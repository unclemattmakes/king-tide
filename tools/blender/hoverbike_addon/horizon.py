...
``HOVERBIKE_PT_track_*`` sub-panels.
"""
...
class HOVERBIKE_OT_add_horizon_ring(Operator):
    ...
    *Reset Horizon Ring* to start over from the procedural starter."""
    ...
    bl_idname = "hoverbike.add_horizon_ring"
...
class HOVERBIKE_OT_reset_horizon_ring(Operator):
    ...
    bl_idname = "hoverbike.reset_horizon_ring"
...
class HOVERBIKE_OT_edit_horizon_ring(Operator):
    ...
    bl_idname = "hoverbike.edit_horizon_ring"
...
_CLASSES: tuple[type, ...] = (
    HOVERBIKE_OT_add_horizon_ring,
    HOVERBIKE_OT_reset_horizon_ring,
    HOVERBIKE_OT_edit_horizon_ring,
    HOVERBIKE_OT_delete_horizon_ring,
)
