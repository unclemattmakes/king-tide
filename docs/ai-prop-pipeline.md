...
- **Env:** `C:\Users\matts\miniconda3\envs\comfyui` (Python 3.11, torch **cu128** — Blackwell needs it).
- **Repo:** `C:\Users\matts\git\ComfyUI`. **Model:** SDXL base 1.0 in `models/checkpoints/sd_xl_base_1.0.safetensors`.
...
```python
import sys; sys.path.insert(0, r"C:\Users\matts\projects\hoverbike")
...
- **Start Hunyuan** (background; **cd into the repo dir**):
  ```powershell
  Set-Location 'C:\Users\matts\git\ai-gen\Hunyuan3D-2'
  & 'C:\Users\matts\miniconda3\envs\hunyuan\python.exe' api_server.py --port 8080
  ```
