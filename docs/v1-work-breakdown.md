...
| **6. Modes** | M16 | Time Trial + Cup wiring + leaderboard backend. Mode buttons activate. | 🟡 cup wiring landed via Dev Placeholder Cup; Time Trial + leaderboard still pending |
