...
| **6. Modes** | M16 | Time Trial + Cup wiring + leaderboard backend. Mode buttons activate. | 🟡 Time Trial + ghost recording shipped; Cup wiring + leaderboard backend still pending |
